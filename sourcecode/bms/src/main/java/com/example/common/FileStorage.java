...
import com.example.data.FileInfoBean;
import com.google.gson.Gson;

public class FileStorage {
    public static final Logger LOGGER = LoggerFactory.getLogger(FileStorage.class);
    public static interface FILE_TYPE {
    	public static Long PRODUCT = 1L;
    	public static Long ACCOUNT = 2L;
    }

    static final String URL = CommonUtil.getConfig("fileStorage.serverUrl");
   /**
